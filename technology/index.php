...
<body id="technology"> <!--identifies current page for navigation bar underline.-->
   <div class="wrapper">
      ...
      <div id="content">
         ...
         <div id="card-top">
            <ul id="top-list">
               <li id="top" class="right1"><!--<a href="#skip-two">--><p>Safety</p></a></li>
               <li id="top" class="right1 left1"><!--<a href="#skip-three">--><p>Performance</p></a></li>
               <li id="top" class="right1 left1"><!--<a href="#skip-four">--><p>Control</p></a></li>
               <li id="top" class="left1"><!--<a href="#skip-five">--><p>Stability</p></a></li>
            </ul>
         </div>
         
         <div id="tech-pics">
            <img src="../images/tech/jump.png" width="280" height="150" />
            <img src="../images/tech/snow1.jpg" width="280" height="150" class="mid" />
            <img src="../images/tech/horse2.png" width="280" height="150" />
         </div>

         <div id="tech-wrap">
   
            <div id="tech-one" class="tech-pad">
               <h1>
               ...
               <h2>
                  ...
                  <ul>
                     ...
                     <li>Mining &amp; Agricultural equipment</li>
                  </ul>
               ...
               <h1>Product Description / Characteristics</h1>  
            ...
            <div id="tech-two" class="tech-pad">
               <img src="../images/tech2.png" width="845" height="403">
               ...
               <h2>
                  ...
                  <br />
                  <br />
                  The Wesll Ski-Machine employees&#39; proprietary leaning technology and custom skis&#8211;with edges, not standard snowmobile skids with carbides.&nbsp; Skis are engineered to deflect and carve, skids are not.&nbsp; Directional stability is imparted to our machine through ski camber and toe adjustment which provides approximately 8 feet of total effective edge.&nbsp; Conversely, the present day modern snowmobile is directed by approximately 6-24 inches of total carbide, usually located in the center of their short skids. 
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  <b>Problem:</b> Increasing track size makes a machine more difficult to control on the trail.
                  <br />
                  <b>Solution:</b> Stop snowmobiling, start skiing.
                  <br />
                  <br />
            ...
            <div id="tech-three" class="tech-pad">
               <img src="../images/tech/tech-17.png" width="845" height="549" >
            </div>
         
            <div id="tech-four" class="tech-pad">
               <img src="../images/tech/tech-16.png" width="850" height="702" >
            </div>
         
            <div id="tech-five" class="tech-pad">
               <img src="../images/tech/tech-18.png" width="845" height="556" class="tech-img-4" >
               <h1>
            ...
            <div id="tech-six" class="tech-pad">
               <img src="../images/tech/tech-20.png" width="845" height="513" >
            </div>

            <div id="tech-seven" class="tech-pad">
               <img src="../images/tech/tech-19.png" width="850" height="445" class="tech-img-6" >
            </div>
